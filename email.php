...
//email content for affiliate email
if(!function_exists('getEmailContent')){
function getEmailContent($id) {
    global $SITE_URL, $SITE_NM;
    //This is for affiliate.php page mail content
    if ($id == 1) {
        $content = '<p>'.$content = EmailTemplate::getEmailTemplate('affiliate')->content.'</p>';
        $content.= "<table border='0' cellpadding='3' cellspacing='0' width='500' align='left' class='style13'>";

        $content.="<tr><td><font style='font-size: 12px;font-family: Arial, Helvetica, sans-serif;color: #333333;'>Hey, have you heard of this site? I became a Member for Free and thought you might want to check it out too! " . "</font></td></tr><tr><td height='5'></td></tr><tr style='font-size: 12px;font-family: Arial, Helvetica, sans-serif;color: #333333;'>
			<td>This is not a typical auction, at this site , they auction brand new, brand name products at up to 90 percent off retail!  The prices on the auctions start at just 10 Cents and every time a bid is placed the price goes up 10 cents.  When the countdown clock gets to zero, whoever placed the last bid, wins.  The deals they have are unbelievable.  It's really unique and really cool. </td>
			</tr>";

        $content.="<tr><td height='5'></td></tr><tr style='font-size: 12px;font-family: Arial, Helvetica, sans-serif;color: #333333;'>
			<td>All of the auctions are for  brand new, name brand products, all selling for less than 10 percent of the retail price!  You won't believe these prices, I've seen 42 Inch Plasma Tv's sell for less than $15.00, an iPod Nano sold for $1.38 and a PlayStation 3 sold for just $7.34! 
check it out at <a href='" . $SITE_URL . "registration.php?ref=%1\$s'>" . $SITE_NM . "</a><br/>
    or copy this url: ". $SITE_URL . "registration.php?ref=%1\$s"."
</td>
			</tr>";
...
// One mail defined in functions.php because it is send in system when auction is ended. It is a wonauction email.
?>