...
<script src="../js/jchartfx.coreVector3d.js" type="text/javascript"></script>
...
<script src="../js/jchartfx.ui.js" type="text/javascript"></script>

<link type="text/css" href="<?php echo $SITE_URL;?>/backendadmin/css/jquery.qtip.css" rel="stylesheet" />
<style>
#chartToolTip {
...
<!--[if !IE]>start logo and user details<![endif]-->
 ...
 <div id="logo_user_details">
   ...
   <div id="notification_area" style="position:absolute;top:30px;right:650px;z-index:5000;"></div>
    <h1 id="logo"><a href="innerhome.php"><?php echo $SITE_NM; ?> Administration Panel</a></h1>
    ...
    <div id="user_details">
        <ul id="user_details_menu">
           ...
           if(!empty($_SESSION['user_level']) & is_numeric($_SESSION['user_level'])){
                                     ...
                                     $admin_level = db_fetch_array(db_query("select * from user_levels where id = '$_SESSION[user_level]' limit 1"));
                                     echo "<li class=\"unauthorised2\" style=\"height:15px;\">$admin_level[admin_level]</li>";
                                     }
                                     ?>
