		    ...
		    <div id="buybids-box" class="content">
                    ...
                    ?>
                                    ...
                                    <div class="bid-box" style="display:none;">
                                        <div style="background-image:url(<?php echo $SITE_URL;?>uploads/bidpack/<?php echo urlencode($obj->bidpack_banner);?>) left top no-repeat;background-size: 150px 150px;">
 ...
 ?>
                    ...
                    ?>
                           ...
                           <?php } ?>
			 <div id="column-left">
			  <div id="contentsidebarsmall">
			      <?php include("include/$template/leftside.php"); ?>
			  </div>
