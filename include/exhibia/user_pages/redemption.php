                        ...
                        <div class="bid-box">
                            ...
                            <div class="bid-redem">
                                        <?php if($obj["redem_qty"]>$obj["redem_soldqty"]) { ?>
                                            <?php if ( $uid == 0 ) { ?>
                                <a class="gradient button" onclick="window.location.href='login.php'" onmouseout="$(this).text('<?php echo REDEEM;?>')" onmouseover="$(this).text('<?php echo LOGIN; ?>')"><?php echo REDEEM;?></a>

                                                <?php } else { ?>
                                <a class="gradient button" onclick="window.location.href='<?php echo SEOSupport::getRedeemUrl($obj["name"], $obj["id"]); ?>'"><?php echo REDEEM;?></a>

                                                <?php } ?>                                            
                                            <?php } else { ?>
                                <a class="gradient button" ><?php echo SOLD;?></a>
                                            <?php } ?>
                            </div><!-- /bid-redem -->
                        </div><!-- /bid-box -->
                                <?php } ?>
