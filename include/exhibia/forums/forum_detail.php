	 ...
	 <div class="tab-area">
                ...
                <div class="clear">&nbsp;</div>
                <div class="clear">&nbsp;</div>
                <div class="greenfont" style="text-align:center"><b><?php echo TOPIC_SUBMITED_SUCCESSFULLY; ?></b></div>
                    <?php }?>
...
//							$fcontent = wordwrap(,75,"\n");
                        ...
                        <div class="forumtitlelastposttext">
                            ...
                            ?>
                        <div class="forumtitletext" style="width:817px; text-align:center; "><?php echo NO_TOPIC_TO_DISPLAY; ?></div>
