...
if($catid<>0) {
    $query="select * from games where name like '$iid%' order by gameID";
                                            ...
                                            <div class="sct_left">
                                                <div class="sct_right">                                                    
                                                    ...
                                                    <ul class="system_messages">
                                                        <li class="blue"><span class="ico"></span><strong class="system_title">No Games To Display</strong></li>
                                                    </ul>
                                                        <?php }else {?>
                                                    <div  id="product_list">
                                                            ...
                                                            <div class="table_wrapper_inner">
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%">
                                                                    <tbody>
                                                                        <tr>
                                                                            <th>Game Title</th>
                                                                            <th style="width: 65px;">Min Players</th>
                                                                            <th style="width: 65px;">Max Players</th>
                                                                            <th style="width: 65px;">URL</th>
                                                                            ...
                                                                            <td style="width: 120px;">
                                                                                <div class="actions_menu">
                                                                                    <ul><li>
                                                                                            ...
                                                                                            <a class="edit" href="get_addon.php?addon=games&page=<?php echo strtolower($row->name);?>/admin/settings.php">Settings</a>
                                                                                                       
                                                                                        </li>
                                                                                        <li>
                                                                                                        <?php if($count=="-2") { ?>
                                                                                            <a class="edit" href="get_addon.php?addon=games&page=admin/addgame.php&game_edit=<?=$row->gameID;?>">Edit</a>
                                                                                                            <?php }else {?>
                                                                                            <a class="edit" href="get_addon.php?addon=games&page=admin/addgame.php&game_edit=<?=$row->gameID;?>&tempnew=1">Edit</a>
                                                                                                            <?php }?>
                                                                                        </li>
                                                                                        <?php if($id!=1){?>
                                                                                        <li><a class="delete" href="get_addon.php?addon=games&page=admin/addgame.php&game_delete=<?=$row->gameID;?>">Delete</a></li>
                                                                                        <?php }?>
                                                                                    </ul>
                                                                                </div>
                                                                            </td>
