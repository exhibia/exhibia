...
function createTableGames(){
	$SQLCreateTableGames = "CREATE TABLE chess (
	...
	$Result = db_query($SQLCreateTableGames);
        return $Result;
}
...
function createTableHistory(){
	...
	$Result = db_query($SQLCreateTableHistory);
        return $Result;
}
...
function createTableMessages() {
	...
	$Result = db_query($SQLCreateTableMessages);
        return $Result;
}
...
function createTablePieces(){
	...
	$Result = db_query($SQLCreateTablePieces);
        return $Result;
}
...
function createTablePreferences() {
	...
	$Result = db_query($SQLCreateTablePreferences);
        return $Result;
}
...
function createTableCommunication() {
	...
	$Result = db_query($SQLCreateTableCommunication);
        return $Result;
}
...
function insertSampleFieldIntoCommunications() {
	...
	$Result = db_query($SQLInsertIntoCommunication);
        return $Result;
}
...
function createDB($user,$password,$server,$DBname){
   $dbh=db_connect ($server, $user, $password)
