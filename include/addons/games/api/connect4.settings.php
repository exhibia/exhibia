...
if(!empty($_REQUEST['submit'])){
	...
	if(db_num_rows(db_query("select * from sitesetting where name = '$_REQUEST[domain]:game:connect4:$key'")) == 0){
	    db_query("isert into sitesetting (id, name, value) values(null, '$_REQUEST[domain]:game:connect4:$key', '$value');");
...
$admin = 'true';
require($BASE_DIR . "/include/addons/games/api/connect4.config.inc.php");
