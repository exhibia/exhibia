...
<?php include("include/topmenu.php"); ?>
  ...
  <?php include("include/addons/auction_boxes/pas/top_auctions/index.php"); ?>
  <?php include("include/addons/auction_boxes/pas/auction_description/index.php"); ?>

  
                
<div class="custom_box_content" id="custom_box_content_12" contenteditable="true"  title="12"><?php $content = 12; include("include/addons/custom_content/get_content.php"); ?></div>
...
<div class="custom_box_content" id="custom_box_content_13" contenteditable="true"  title="13"><?php $content = 13; include("include/addons/custom_content/get_content.php"); ?></div>
              
                <!-- Begin Main Auction -->
                        <div id="bid-information">
 <?php include("include/addons/pas/auction_descriptions/index.php"); ?> 
                    ...
                    <?php } ?>
                        ...
                        <?
                                            if ($uid == 0) {
                        ?>
                                                <a class="register-button"  onclick="window.location.href='register.php'">Register</a>
                        ...
                        ?>
                                                    <div id="autobider">
                                                        <ul>
                                                            <li class="current"><a class="tabheader" rel="bookautobidder<?= $obj["nailbiterauction"] == 0 ? "|myautobidder" : "";
                        ?>"><?php echo BOOK_AUTOBIDDER; ?></a></li>
                ...
                ?>
						      ...
						      <?php echo $pname; ?>
                                           ...
                                           <p class="description"><?php echo str_replace("<br />", "", $short_desc); ?></p>
                                           <div class="clear"></div>
                            ...
                            ?>
                                                   <div class="corner_imagev_detail">
                                                       <img src="<?php echo $SITE_URL;?>img/icons/<?php echo $cornerImag; ?>"  alt=""/>
                                                   </div>
                            <?php } ?>
                                               <div id="mainimage1">
                                <?php if ($picture != "") {
                                ...
                                <?php } ?>
                                       ...
                                       <div class="product-small">
                                           <span onclick="changeimage(1);" id="otherimageprd_1" style="cursor: pointer;">
                                               <img src="<?= $UploadImagePath; ?>products/thumbs/thumb_<?= $picture; ?>" alt="product" border="0" />
                                           </span>
                                       </div><!-- /product-small -->
                        <?php if ($picture2 != "") {
                        ?>
                                                   <div class="product-small">
                                                       <span onclick="changeimage(2);" id="otherimageprd_2" style="cursor: pointer;"><img src="<?= $UploadImagePath; ?>products/thumbs/thumb_<?= $picture2; ?>" alt="product" border="0" /></span>
                                                   </div><!-- /product-small -->
                        <?php } ?>
                        ...
                        ?>
                                                   <div class="product-small">
                                                       <span onclick="changeimage(3);" id="otherimageprd_3" style="cursor: pointer;"><img src="<?= $UploadImagePath; ?>products/thumbs/thumb_<?= $picture3; ?>" alt="product" border="0" /></span>
                                                   </div><!-- /product-small -->
                        <?php } ?>
                        ...
                        ?>
                                                   <div class="product-small">
                                                       <span onclick="changeimage(4);" id="otherimageprd_4" style="cursor: pointer;"><img src="<?= $UploadImagePath; ?>products/thumbs/thumb_<?= $picture4; ?>" alt="product" border="0" /></span>
                                                   </div><!-- /product-small -->
                        <?php } ?>
                                                   ...
                                                   <div class="product-box auction-item" title="<?= $obj["auctionID"]; ?>" id="auction_<?= $obj["auctionID"]; ?>">
                                                       <div class="product-content">
                                                           ...
                                                           <p class="pricebox">
                                                               ...
                                                               <span id="price_index_page_<?= $obj["auctionID"]; ?>">---</span><br />
                        ...
                        <?php if ($uid <> 0) { ?>
							...
							<input type="hidden" id="onlineperbidvalue_text" value="<?php echo $onlineperbidvalue; ?>"/>
                                    ...
                                    <?php } ?>
                                                   ...
                                                   <p class="result" style="position:relative;top:-25px;">
                                                   ...
                                                   <p style="position:relative;top:-15px;"><small><?php echo THE_WORTH_UP_TO_PRICE_REFLECTS_THE_MANUFACTURERS_SUGGESTED_RETAIL_PRICE; ?></small></p>
                                               </div><!-- /product-content -->
                                           </div><!-- /product-box -->
...
<?php } ?>
				  ...
				  <div class="clear"></div>
				  <?php
				   include("include/buynow.php");
				   ?>
  <?php include("include/addons/auction_boxes/pas/product_details/index.php"); ?>
<div class="custom_box_content" id="custom_box_content_14" contenteditable="true"  title="14"><?php $content = 14; include("include/addons/custom_content/get_content.php"); ?></div>
