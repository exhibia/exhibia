...
background: url("<?php echo $games_server; ?>//include/addons/games/connectfour/image/connect4.png");
...
var debug = '';
	...
	function congratulate(color) {
		...
		$.ajax({
			url: '<?php echo $games_server; ?>/include/addons/games/connectfour/check_game_data.php',
...
$(document).ready(function() {
	...
	var soundHandle = document.getElementById('piece_drop');
		soundHandle.src = '<?php echo $games_server;?>/include/addons/games/connectfour/sounds/piece-drop.wav';
	});	
