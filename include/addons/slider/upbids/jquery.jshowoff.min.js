...
(function($) {
	...
	$.fn.jshowoff = function(settings) {
		...
		this.each(function(i) {
			...
			function pause_on_id(id){
			  
					//for(counter = 1; counter <= gallery.length; counter++;) {
					  
					 // console.log(gallery.id.prop('id'));
					 // if(id = gallery.id.prop('id')){
			...
			function addSlideLinks() {
				$wrap.append('<ul class="jshowoff-slidelinks '+uniqueClass+'-slidelinks"></ul>');
				$.each(gallery, function(i, val) {
					var linktext = $(this).attr('title') || i+1;
					$('<li><a class="jshowoff-slidelink-'+i+' '+uniqueClass+'-slidelink-'+i+'" href="#null">'+linktext+'</a></li>').bind('click', {index:i}, function(e){ goToAndPause(e.data.index); return false; }).appendTo('.jshowoff-slidelinks');
				});
			};		
