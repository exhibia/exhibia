...
#bids_count_tb, #free_bids_count_tb {
color:#fff!important;
}
#connection_speed {
position:relative;
  ...
  <img class="avatar" src="uploads/avatars/<?php echo $row->avatar; ?>" width="20" height="20" alt="image description" />
		...
		$('.user_badges_bar').each( function(){
			...
			include($BASE_DIR . "/include/addons/user_levels/inviter_link.php");
		     ...
		     ?>
		     <li><a href="mydetails.php">My Account</a></li>
                    <li id="toolbar-buy-more" style="cursor:pointer;"><a href="buybids.php"><?php echo BUY_BIDS ?></a></li>
                </ul> 
            </div>
