...
if ( isset($_POST["addGame"]) ) {	// Add new Game
	...
	db_query("insert into sitesetting values(null, 'games', '" . addslashes($name) . "', '', '', '');");
        ...
        db_query("INSERT INTO games (language_id, name, description, status, min_players, max_players, url) VALUES ('1','$name','$desc','$status', '$min_players', '$max_players', '$url')") or die ("Insert error ".db_error());
        $cat_id = db_insert_id();
