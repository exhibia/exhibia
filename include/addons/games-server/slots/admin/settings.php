...
include($BASE_DIR . "/include/addons/games/slots/config.inc.php");
 ?>
		  ...
		  <!--[if !IE]>start title wrapper<![endif]-->
                            ...
                            <div class="section_content">
						      ...
						      foreach($fruits as $key => $fruit){
						       ...
						       <label><img style="width:45px; height:auto;" src="../include/addons/games/slots/image/<?php echo $fruit;?>.png" /></label>
							    ...
							    foreach($payouts[$fruit] as $repeats => $payout){
							      ...
							      <li style="display:inline;">
								    <ul style="list-style:none;display:inline;float:left;">
									  ...
									  while($i <= $repeats){
									  ?>
									  <img style="width:15px; height:auto;display:inline;float:left;" src="../include/addons/games/slots/image/<?php echo $fruit;?>.png" />
