...
<?php
	  ...
	  echo "<li style=\"text-decoration:none;\" class=\"message\"><span id=\"message_$row[id]\" style=\"text-decoration:none;\"> <ul style=\"text-decoration:none;\"> <li style=\"display:inline;font-weight:bold;\">$row[sender]</li> <li style=\"display:inline;\">$row[message]</li></ul></span> </li>";
