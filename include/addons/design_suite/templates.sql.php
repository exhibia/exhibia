...
db_query("delete from stylesheets where page = '$key'");
...
$file_pointer = str_replace("'../img/" . $img_name, "'$SITE_URL/get_file.php?id=$id", $file_pointer);
$file_pointer = str_replace("'../img/backgrounds/" . $img_name, "'$SITE_URL/get_file.php?id=$id", $file_pointer);
$file_pointer = str_replace("\"../img/" . $img_name, "\"$SITE_URL/get_file.php?id=$id", $file_pointer);
$file_pointer = str_replace("'../img/buttons/" . $img_name, "'$SITE_URL/get_file.php?id=$id", $file_pointer);
$file_pointer = str_replace("'../img/icons/" . $img_name, "'$SITE_URL/get_file.php?id=$id", $file_pointer);
$file_pointer = str_replace("'../img/images/" . $img_name, "'$SITE_URL/get_file.php?id=$id", $file_pointer);
$file_pointer = str_replace("'../img/banner/" . $img_name, "'$SITE_URL/get_file.php?id=$id", $file_pointer);
...
$file_pointer = str_replace($img_name, "$SITE_URL/get_file.php?id=$id", $pointer['value']);
