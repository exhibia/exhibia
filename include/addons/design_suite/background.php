...
if(empty($_REQUEST['backgroundset'])){
...
<center>
    ...
    <table align="center" style="padding-top:10px;padding-bottom:10px;margin:0 auto;" width="1200px;" class="background-editor">
      <tr>
