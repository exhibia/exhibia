$(document).ready(function() {
  ...
  test("utility: template", function() {
    ...
    var customWithSpecialChars = _.template("<ul><?php for (key in people) { ?><li><?= people[key] ?></li><?php } ?></ul>");
    ...
    var quoteInStatementAndBody = _.template("<?php if(foo == 'bar'){ ?>Statement quotes and 'quotes'.<?php } ?>");
    equals(quoteInStatementAndBody({foo: "bar"}), "Statement quotes and 'quotes'.");
