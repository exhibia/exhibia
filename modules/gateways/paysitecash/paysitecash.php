...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body><!-- onload="frmnew();">-->
        <form name="_xclick" action="https://billing.paysite-cash.biz/" method="post">
            ...
            <input type="text" name="url_ref" value="http://www.antilles-enchere.com/"/>
<input id="url" type="text" maxlength="255" size="50" value="http://www.antilles-enchere.com/" name="url">
<input id="name" type="text" maxlength="255" size="50" value="antilles-enchere" name="name">
<input id="email" type="text" maxlength="255" size="50" value="administrateur@antilles-enchere.com" name="email">
        ...
        <!--<input type="text" name="txtRedirectSuccessfulURL" value="<?php echo $SITE_URL."payment_paysite_notify.php";?>"/>
          ...
          <input type="text" name="txtMerchantReference" value="<?php echo $mref; ?>"/>
            <input type="text" name="txtRedirectFailedURL" value="<?php echo $SITE_URL . "payment_unsuccess.php?payfor=$payfor&orderid=$orderid"; ?>"/>-->
