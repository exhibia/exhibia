                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <div class="forms">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="inputs">
                                                                        <ul class="inline">
                                                                            <li><input class="checkbox" <?echo $idealing->isEnabled()==true?"checked":""?> type="checkbox" name="enabled" value="1"/> Enabled</li>
                                                                ...
                                                                <div class="row">
                                                                    <div class="buttons">
                                                                        <ul>
                                                                            <li>
                                                                                <input type="hidden" value="idealing" name="for"/>
