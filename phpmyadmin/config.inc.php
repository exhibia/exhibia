 ...
 */
$cfg['blowfish_secret'] = '4zpyfJhWL0IT1kLbby9oHPfQiIlf3jer';
...
/**
 * Possible values:
 * 'mysql_structure.php' = tables list
 * 'mysql_sql.php' = SQL form
 * 'mysql_search.php' = search query
 * 'mysql_operations.php' = operations on database
 *
 * @global string $cfg['DefaultTabDatabase']
 */
$cfg['DefaultTabDatabase'] = 'mysql_structure.php';
