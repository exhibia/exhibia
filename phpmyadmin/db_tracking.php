 ...
 */
require 'libraries/mysql_common.inc.php';
$url_query .= '&amp;goto=tbl_tracking.php&amp;back=mysql_tracking.php';

// Get the database structure
$sub_part = '_structure';
require 'libraries/mysql_info.inc.php';
...
?>
    ...
    while ($one_result = PMA_DBI_fetch_array($all_tables_result)) {
        ...
        $delete_link = 'mysql_tracking.php?' . $url_query . '&amp;table='
            . htmlspecialchars($version_data['table_name'])
            . '&amp;delete_tracking=true&amp';
        ?>
        <tr class="noclick <?php echo $style;?>">
            <td><?php echo htmlspecialchars($version_data['mysql_name']);?></td>
