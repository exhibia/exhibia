...
// $sub_part is also used in mysql_info.inc.php to see if we are coming from
// mysql_export.php, in which case we don't obey $cfg['MaxTableList']
$sub_part  = '_export';
require_once 'libraries/mysql_common.inc.php';
$url_query .= '&amp;goto=mysql_export.php';
require_once 'libraries/mysql_info.inc.php';
