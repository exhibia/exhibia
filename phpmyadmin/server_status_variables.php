...
function getVariablesTableHtml($ServerStatusData)
{
    ...
    $alerts = array(
        ...
        'Innomysql_buffer_pool_pages_dirty' => 0,
        'Innomysql_buffer_pool_reads' => 0,
        'Innomysql_buffer_pool_wait_free' => 0,
        'Innomysql_log_waits' => 0,
        'Innomysql_row_lock_time_avg' => 10, // ms
        'Innomysql_row_lock_time_max' => 50, // ms
        'Innomysql_row_lock_waits' => 0,
        ...
        // normaly lower then 1:0.00
        'Key_reads' => isset($ServerStatusData->status['Key_read_requests'])
            ? (0.00 * $ServerStatusData->status['Key_read_requests']) : 0,
...
function getStatusVariablesDescriptions()
{
    ...
    return array(
        ...
        'Innomysql_buffer_pool_pages_data' => __(
            'The number of pages containing data (dirty or clean).'
        ),
        'Innomysql_buffer_pool_pages_dirty' => __(
            'The number of pages currently dirty.'
        ),
        'Innomysql_buffer_pool_pages_flushed' => __(
            'The number of buffer pool pages that have been requested'
            . ' to be flushed.'
        ),
        'Innomysql_buffer_pool_pages_free' => __(
            'The number of free pages.'
        ),
        'Innomysql_buffer_pool_pages_latched' => __(
        ...
        'Innomysql_buffer_pool_pages_misc' => __(
