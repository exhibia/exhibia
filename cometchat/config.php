...
define('BASE_URL','/include/addons/cometchat/');
...
$trayicon[] = array('chatrooms','Chatrooms','modules/chatrooms/index.php','_lightbox','560','300','','1','1');
$trayicon[] = array('announcements','Announcements','modules/announcements/index.php','_lightbox','280','300','','1','');
...
$plugins = array('smilies','clearconversation','chathistory','report');
...
$crplugins = array('colors','smilies');
...
$floodControl = '100';			// Chat spam control in milliseconds (Disabled if set to 0)
...
define('MEMCACHE','2');				// Set to 0 for disable caching, 1 for memcaching, 2 for file caching, 3 for memcachier, 4 for APC, 5 for Wincache, 6 for sqlite, 7 memcached 
define('MC_SERVER','localhost');	// Set name of your memcache  server
define('MC_PORT','11211');			// Set port of your memcache  server
define('MC_USERNAME','required="true"/');							// Set username of memcachier  server
define('MC_PASSWORD','required="true"/');			// Set password your memcachier  server
