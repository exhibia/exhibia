...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="single">
     <?php
	   ...
	   if(!empty($_GET['page'])){
$_SERVER['PHP_SELF'] = $_GET['page'];
}   
	      if(file_exists("include/$template/cms_pages/aboutus.php")){
	  
		include("include/$template/cms_pages/aboutus.php");
		}else{
		
		include("include/cms_pages/aboutus.php");
