...
if ( isset($_POST['submit']) ) {
    ...
    if ( $content != "" ) {
        db_query("update static_pages set content='$content' where page='$id'") or die(db_error());
    ...
    $result = db_query("select content from static_pages where page='$id'");
    $content = db_num_rows($result) > 0 ? stripslashes(db_result($result, 0)) : "";
