...
if (isset($_REQUEST['submit'])) {
    ...
    if($timerdelay == 1){
    $_REQUEST['resettime'] = number_format($_REQUEST['resettime'] + 4);
    }
    ...
    $reserve_icon = $_REQUEST['reserve_icon'];
    $color = $_REQUEST['color'];
    $sold_color = $_REQUEST['sold_color'];
    ...
    if (is_numeric($leavetimeout) == false) {
        ...
        if(db_num_rows(db_query("select * from sitesetting where name = 'tutorials'")) >= 1){
        $sql = "update sitesetting set value='$tutorials' where name='tutorials';";
        db_query($sql) or die('Query Not Success');
        }else{
        db_query("insert into sitesetting (id, name, value) values(null, 'tutorials', '$tutorials');");
        } 
    
        if(db_num_rows(db_query("select * from sitesetting where name = 'price_color'")) >= 1){
        $sql = "update sitesetting set value='$color' where name='price_color';";
        db_query($sql) or die('Query Not Success');
        }else{
        db_query("insert into sitesetting (id, name, value) values(null, 'price_color', '$color');");
        } 
        
        
        if(db_num_rows(db_query("select * from sitesetting where name = 'sold_color'")) >= 1){
        $sql = "update sitesetting set value='$sold_color' where name='sold_color';";
        db_query($sql) or die('Query Not Success');
        }else{
        db_query("insert into sitesetting (id, name, value) values(null, 'sold_color', '$sold_color');");
        } 
        
        if(db_num_rows(db_query("select * from sitesetting where name = 'reserve_icon'")) >= 1){
        $sql = "update sitesetting set value='$reserve_icon' where name='reserve_icon';";
        db_query($sql) or die('Query Not Success');
        }else{
        db_query("insert into sitesetting (id, name, value) values(null, 'reserve_icon', '$reserve_icon');");
        } 
        
        
        if(db_num_rows(db_query("select * from sitesetting where name = 'resettime'")) >= 1){
        $sql = "update sitesetting set value='" .str_replace(",", "", $resettime) . "' where name='resettime';";
        db_query($sql) or die('Query Not Success');
        }else{
        db_query("insert into sitesetting (id, name, value) values(null, '" .str_replace(",", "", $resettime) . "', '$resettime');");
        } 
        ...
        if(db_num_rows(db_query("select * from sitesetting where name = 'color'")) >= 1){
        $sql = "update sitesetting set value='$color' where name='color';";
        db_query($sql) or die('Query Not Success');
        }else{
        db_query("insert into sitesetting (id, name, value) values(null, 'color', '$color');");
        }  
...
$version = explode(":", $version[0]);
    ...
    $sql = "select * from sitesetting where name='tutorials';";
    $result = db_query($sql);
    if (db_num_rows($result) > 0) {
        $obj = db_fetch_object($result);
        $gavel = $obj->value;
        ...
        $sql = "insert into sitesetting(name,value) values('tutorials','1');";
        db_query($sql) or die('Insert Not Success');
    }  
    ...
    if (db_num_rows($result) > 0) {
        ...
        $sql = "insert into sitesetting(name,value) values('gavel','0');";
        db_query($sql) or die('Insert Not Success');
    }
    ...
    if (db_num_rows($result) > 0) {
        ...
        $sql = "insert into sitesetting(name,value) values('fireworks','0');";
        db_query($sql) or die('Insert Not Success');
    }
...
$version = explode(":", $version[0]);
    ...
    if (db_num_rows($result) > 0) {
        $obj = db_fetch_object($result);
        $sold_color = $obj->value;
        db_free_result($result);
    } else {
        $sql = "insert into sitesetting(name,value) values('sold_color','red');";
        db_query($sql) or die('Insert Not Success');
    }  
    ...
    if (db_num_rows($result) > 0) {
        $obj = db_fetch_object($result);
        $price_color = $obj->value;
        db_free_result($result);
    } else {
        $sql = "insert into sitesetting(name,value) values('aggregate','#000');";
        db_query($sql) or die('Insert Not Success');
    }  
...
<?php } ?><!--[if !IE]>start fieldset<![endif]-->
									...
									<span class="system message">YOU NEED TO SET THIS UP FOR YOUR SERVER</span>
                                                                ...
                                                                <!--[if !IE]>start row<![endif]-->
                                                                <div class="row">
                                                                    <label>Bid Price (used for buy it now calculations..used bids * this value):</label>
                                                                    <div class="inputs">
                                                                        <span class="input_wrapper">
...
now</span>
							       ...
							       <!--[if !IE]>start row<![endif]-->
									      ...
									      <option value="1" <?php if($tutorials == true){ echo 'selected'; } ?>>Enabled</option>
									      <option value="0" <?php if($tutorials != true){ echo 'selected'; } ?>>Disabled</option>
									   </select>
                                                                     </span>
                                                                        <span class="system required">*</span>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="inputs">
                                                                        <span class="input_wrapper blank">
                                                                            ...
                                                                            <option value="200" <?php echo $reftimeout == '200' ? 'selected' : ''; ?>>.2</option>
                                                                            <option value="300" <?php echo $reftimeout == '300' ? 'selected' : ''; ?>>.3</option>
                                                                            <option value="400" <?php echo $reftimeout == '400' ? 'selected' : ''; ?>>.4</option>
                                                                            <option value="500" <?php echo $reftimeout == '500' ? 'selected' : ''; ?>>.5</option>
                                                                            <option value="600" <?php echo $reftimeout == '600' ? 'selected' : ''; ?>>.6</option>
                                                                            <option value="700" <?php echo $reftimeout == '700' ? 'selected' : ''; ?>>.7</option>
                                                                            <option value="800" <?php echo $reftimeout == '800' ? 'selected' : ''; ?>>.8</option>
										<option value="1000" <?php echo $reftimeout == '1000' ? 'selected' : ''; ?>>1</option>
						      ...
						      <td>
								  ...
								  <td colspan="4">
									  ...
									  <td>
									    ...
									    <label>Reserve Icon:</label>
                                                                    
                                                                            <select name="reserve_icon">
                                                                                <option value="0" <?php
                                                                                        if ($reserve_icon == '0') {
                                                                                            echo " selected";
									      ...
									      <label>Reserve Reset Time:</label>
											  ...
											  <?php 
											   ...
											   if($timerdelay == 1){
											    $resettime = number_format($resettime - 4);
											    }
											  $i = 10;
											  while($i <= 300){
											  ?>
											  ...
											  ?>
											   <option value="1800" <?php if($resettime == 1800) { echo ' selected'; } ?>>30 minutes</option>
											   <option value="3600" <?php if($resettime == 3600) { echo ' selected'; } ?>>1 hour</option>
								  ...
								  <tr>
								  <td colspan="4">
								      <h2>Auction Effects Settings</h2>
								  </td>
								  </tr>
								      <tr>
									  <td>
									   ...
									   <label>Timer Color:</label>
									     <input type="text" id="color" name="color" value="<?php echo $price_color;?>" />
										  
									
									  
									  </td><td>
									  <label>Sold Color:</label>
									     
										      <input type="text" id="sold_color" name="sold_color" value="<?php echo $sold_color;?>" />
