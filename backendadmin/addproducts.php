...
if (!empty($_POST['addproduct'])) {
	   foreach($addons as $key => $value){ 
	      if(file_exists("../include/addons/$value/product/validation.php")){
		include_once("../include/addons/$value/product/validation.php");
	      }
	   }
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title><?php if ($_GET['product_edit'] != "") { 
		    ?> Edit Products<?
		} else {
		    if ($_GET['product_delete'] != "") {
			?> Confirm Delete Products <?php 
		    } else {
		    ?> Add Products <?
        }
    }
?>-<?php echo $ADMIN_MAIN_SITE_NAME ?></title>
       <?php include("page_headers.php"); ?>
	    ...
	    var f1 = document.getElementById('f1');
                ...
                /*	if(f1.winnertitle.value=="")
                {
                        alert("Please Enter Winner Title!!!");
                        document.f1.winnertitle.focus();
                        return false;
                }
                 */
                if(f1.price.value=="")
        ...
        <script  type="text/javascript">
            ...
            {
                /*	if(f1.check_product_qty.checked==true)
                {
				...
				?>
                            ...
                            <div class="section_content">
						      ...
						      <?php } ?>
                                                    ...
                                                    <form name="f1" action='addproducts.php' method='POST' enctype="multipart/form-data" id="f1" onSubmit="return Check('f1')" class="search_form general_form">
								  ...
								  <!--[if !IE]>start row<![endif]-->
									...
									?>
									  ...
									  <label>Product Quantity:</label>
									   <div class="inputs">
										  <span class="input_wrapper">
										      <input type="text" name="product_qty" id="product_qty" size="32" class="text" value="<?php echo $productQty; ?>" maxlength="40" />
										  </span>
										  <span class="required">*</span>
									      </div>
									  </div>
								...
								<?php foreach($addons as $key => $value){ 
									...
									if(file_exists("../include/addons/$value/addproducts.php")){
									  include_once("../include/addons/$value/addproducts.php");
									}
								    }
								}
	                                                        ?>
								      ...
								      <font style="font-size:10px;">Meta Description, Short Description and Keywords are now automatically added from the text provided here</font><br />
                                                                        <span class="">
                                                                            <textarea name="description" id="description" rows="20" cols="" class="text"><?php echo $long_desc; ?></textarea>
                                                                        </span>
                                                                    </div>
                                                                </div>
									  ...
									  <?php if (isset($picture1) && file_exists('../uploads/products/thumbs_big/thumbbig_' . $picture1)) {
									  ?>
                                                                                    <li>
                                                                                        <img alt="" src="../uploads/products/thumbs_big/thumbbig_<?php echo $picture1; ?>"/><br/>
									    ...
									    <?php } 
									    if (isset($picture2) && file_exists('../uploads/products/thumbs_big/thumbbig_' . $picture2)) {
                                                                            ?>
                                                                                    <li><img alt="" src="../uploads/products/thumbs_big/thumbbig_<?php echo $picture2; ?>"/><br/>
									    ...
									    <?php } 
									    if (isset($picture3) && file_exists('../uploads/products/thumbs_big/thumbbig_' . $picture3)) {
                                                                            ?>
                                                                                    <li><img alt="" src="../uploads/products/thumbs_big/thumbbig_<?php echo $picture3; ?>"/><br/>
									    ...
									    <?php } 
									    if (isset($picture4) && file_exists('../uploads/products/thumbs_big/thumbbig_' . $picture4)) {
                                                                            ?>
                                                                                    <li><img alt="" src="../uploads/products/thumbs_big/thumbbig_<?php echo $picture4; ?>"/><br/>
										...
										?>
                                                                                    <span class="button send_form_btn"><span><span><?php echo ($_GET['product_edit'] != "") ? 'Edit Product' : 'Add Product'; ?></span></span><input type="submit" name="<?php echo ($_GET['product_edit'] != "") ? 'editproduct' : 'addproduct'; ?>" /></span>
										<?php
                                                                                }
