...
$result = $orderdb->select($StartRow, $PRODUCTSPERPAGE, 'in checkout');
                                                    ...
                                                    <div  id="product_list">
                                                        ...
                                                        <div class="table_wrapper">
                                                            ...
                                                            <div class="table_wrapper_inner">
                                                             ...
                                                             <h2 style="margin-top:0px;">This is where you can find orders that are wating in a person's cart or have been orphaned for various reasons(user left page before going through with payment or server lost network connection during handshake with gateway. processing from here should only be done after checking for the order on your payment provider(s) website</h2>
                                                                <?php if ($total <= 0) {
                                                                ?>
