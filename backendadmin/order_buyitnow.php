...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Buy It Now Order Report-<?php echo $ADMIN_MAIN_SITE_NAME ?></title>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $('#print-button').click(function(){
                    window.open("order_report_print.php?<?php echo $urldata ?>&for=buyitnow", "print_windows", "location=no,status=yes");

                });

                $('#export-button').click(function(){
                    window.open("order_report_print.php?<?php echo $urldata ?>&for=buyitnow&action=export", "export_to_excel", "width=400,height=300,location=no,status=yes");
