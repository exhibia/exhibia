            ...
            <div id="content">
                ...
                <div id="page">
			      ...
			      if(!empty( $LinkTitle)){
                            ...
                            <div class="section_content">
                                ...
                                <div class="sct">
                                    <div class="sct_left">
                                     ...
                                     if(db_num_rows(db_query("select * from user_levels where allowed_pages like '%" . getcwd() . "/$subHref%' and id = '$_SESSION[user_level]'")) >= 1){
					    ...
					    ?>
                                         <li><a href="#" class="unauthorised"><span><?php echo $subTitle; ?></span></a></li>
                ...
                <div id="sidebar">
                    <div class="inner">
                                <?php include 'include/lefthome.php' ?>
                    </div>
                </div>
