...
if(!empty($_REQUEST['delete'])){
   if(file_exists("$BASE_DIR/include/addons/commentbox/$template/img/$_REQUEST[delete]")){
    unlink("$BASE_DIR/include/addons/commentbox/$template/img/$_REQUEST[delete]");
   }else{
...
echo json_encode(searchDir("$BASE_DIR/include/addons/commentbox/$template/img/",$p,$f,-1));
//}else{
