...
db_query("INSERT INTO `language_choices`  VALUES (null, 'BS', 'Bosnia and Herzegovina', '');");
...
db_query("INSERT INTO `language_choices`  VALUES (null, 'BP', 'Brazil', 'brazil portugese', '');");
...
db_query("INSERT INTO `language_choices`  VALUES (null, 'ZH', 'China', 'chinese');");
...
db_query("INSERT INTO `language_choices`  VALUES (null, 'CZ', 'Czech Republic', 'czech');");
db_query("INSERT INTO `language_choices`  VALUES (null, 'DD', 'East Germany', '');");
db_query("INSERT INTO `language_choices`  VALUES (null, 'DE', 'Germany', 'german');");
...
db_query("INSERT INTO `language_choices`  VALUES (null, 'PT', 'Portuguese', '');");
...
<!--[if !IE]>start row<![endif]-->
 ...
 <ul style="list-style-type:none;">
    <li style="display:inline;"><input name="country[<?php echo $row['id'];?>]" value="<?php echo $row['country'];?>" class="countries" /></li>
    <li style="display:inline;"><input name="abbrev[<?php echo $row['id'];?>]" value="<?php echo $row['abbrev'];?>" /></li>
    <li style="display:inline;"><input name="country[<?php echo $row['lang_text'];?>]" value="<?php echo $row['lang_text'];?>" /></li>
...
function ajaxpages() { jQuery.get("DESIGN/pages.php?lang=" + encodeURIComponent($("#countrycustom").val()), function(data){ $("#pages").html(data);} ); }
                                                        ...
                                                        <div class="forms" id="customform" >     
                                                 <h3 id="pdcode-label">Choose a Language To Customise, Translate or Both</h3>
