...
include("$BASE_DIR/include/addons/design_suite/js/ckeditor/ckeditor_php5.php");
						...
						<tr>
							...
							<td colspan="1" align="left" valign="top" height="100%">
								...
								?>
						 		 ...
						 		 ?><option value="<?php echo $rowAllL['language'];?>" style="word-wrap:break-word;width:100px;" <?php if($rowAllL['language'] = $defaultlanguage){ echo 'selected'; } ?>><?php echo $rowAllL['language'];?></option><?php
