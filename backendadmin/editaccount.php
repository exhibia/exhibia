...
$sel="select * from admin where username='".$_SESSION["UsErOfAdMiN"]."'";
$ressel=db_query($sel);
...
if(isset($_POST['submit'])) {
    ...
    $sql="update admin set pass='$title' where username='".$_SESSION["UsErOfAdMiN"]."'";
    $ressql=db_query($sql) or die("Query Not Success");
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Change Password-<?php echo $ADMIN_MAIN_SITE_NAME ?></title>
                                        ...
                                        <div class="sct_right">
                                            <div class="sct_left">
                                                <div class="sct_right">
                                                    ...
                                                    <form name=addlink action="#" method=post enctype="multipart/form-data" onSubmit="return checkadmin()" class="search_form general_form">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="inputs">
                                                                        <span class="input_wrapper">
                                                                            <input type="password" name="title" size="32" class="text" value="<?php echo $title; ?>"/>
                                                                        </span>
