...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Add Vendors-<?php echo $ADMIN_MAIN_SITE_NAME ?></title>
            ...
            <div id="content">
                ...
                <div id="page">
                    <div class="inner">
                       ...
                       <?php
                       if(file_exists("../include/addons/golf_courses/admin/add_vendors.php")){
                       
                       include("../include/addons/golf_courses/admin/add_vendors.php");
