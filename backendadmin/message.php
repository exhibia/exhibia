...
if(!empty($_REQUEST['msg']) & !is_numeric($_REQUEST['msg'])){
  
	$Message1 = $success;
	$Message2 = urldecode($_REQUEST['msg']);
...
switch ( $_REQUEST['msg'] ) {
    ...
    case 14:
        $Message1 = $success;
        $Message2 = "Auction Added Successfully!!!<a href='manageauction.php'> Click Here </a> to go back";
        break;
    case 15:
        $Message1 = $success;
    ...
    include("$BASE_DIR/include/addons/games/backendadmin/message.php");
...
CONTENT="5;URL=<?php echo $_SERVER['HTTP_REFERER'];?>">
