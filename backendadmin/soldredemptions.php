...
if ($_POST["submit"] != "" || $_GET["sdate"] != "" || $order!='') {
    ...
    /*     * ******************************************** */
   $sql = "select payment_order_history.id as oid, payment_order_history.itemid, payment_order_history.orderid, payment_order_history.itemname, payment_order_history.amount, payment_order_history.datetime, r.id as uid, r.username from payment_order_history  left join registration r on r.id=payment_order_history.userid where payment_order_history.id != '' $wherecase and payment_order_history.payfor='redemption' order by payment_order_history.id ";
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Manage Sold Redemptions-<?php echo $ADMIN_MAIN_SITE_NAME ?></title>
        ...
        <script type="text/javascript">
		  ...
		  $.get('soldredemptions.php?submit=yes&orderid=' + id + '&' + data , function(response){
		...
		$.get('soldredemptions.php?ordertype=' + type + '&orderid=' + id, // URL to the JSON script
				  function(result){
                                            ...
                                            <div class="sct_left">
                                                <div class="sct_right">
                                                    <div class="categoryorder">
                                                        <form id="f1" name="f1" onsubmit="return Check(this)" action="soldredemptions.php" method="post" class="search_form general_form">
...
<?php
                                                                            if ($PageNo > 1) {
                                                                                $PrevPageNo = $PageNo - 1;
?>
                                                                                        <li><a href="soldredemptions.php?<?php echo $urldata ?>&pgno=<?php echo $PrevPageNo; ?>" class="button light_blue_btn"><span><span>PREVIOUS</span></span></a> </li>
                                                            <?php } ?>
                                                            ...
                                                            <?php if ($i == $PageNo) {
 ?>
                                                                                    <li><a href="soldredemptions.php?<?php echo $urldata ?>&pgno=<?php echo $i; ?>" class="current_page"><span><span><?php echo $i; ?></span></span></a></li>
                                                            <?php } else {
                                                            ?>
                                                                                    <li><a href="soldredemptions.php?<?php echo $urldata ?>&pgno=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                                            <?php
                                                                                }
                                                                            }
                                                            ?>
                                                            <?php
                                                                            if ($PageNo < $totalpages) {
                                                                                $NextPageNo = $PageNo + 1;
                                                            ?>
                                                                                <li><a href="soldredemptions.php?<?php echo $urldata ?>&pgno=<?php echo $NextPageNo; ?>" class="button light_blue_btn"><span><span>NEXT</span></span></a> </li>
                                                            <?php } ?>
                                                                        </ul>
